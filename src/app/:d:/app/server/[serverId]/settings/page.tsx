            ...
            <div className="flex flex-col items-left mt-[15px] w-full p-6">
                ...
                <div className="flex flex-row items-center justify-between w-full my-4">
                    <Tabs orientation="vertical" defaultValue="general" className="flex flex-row items-start justify-start w-full h-[70vh]">
                        ...
                        <TabsContent value="boost-perks">
                            <Card className="w-full bg-black border-zinc-700 p-4">
                                <div className="h-[60%] w-full bg-gradient-to-br from-pink-700 to-purple-800 rounded-lg p-4">
                        ...
                        <TabsContent value="module_cases">
                            <CasesAppSettingsCard currentServerData={currentServerData} />
                        </TabsContent>
                        <TabsContent value="module_staff_management">
                            <Card className="w-full bg-black border-zinc-700 p-4">
                        ...
                        <TabsContent value="module_tickets">
                            <Card className="w-full bg-black border-zinc-700 p-4">
                                <div className="flex flex-row h-full w-full items-center justify-center">
