        ...
        <div className="flex flex-col items-left mt-[15px] w-full p-6">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink
                  href={`/:d:/app/server/${serverId}/cases`}
                  className="hover:text-white"
                >
                  Cases
                </BreadcrumbLink>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink
                  href={`/:d:/app/server/${serverId}/cases/${caseId}`}
          ...
          <div
            className={`font-semibold text-4xl ${geistSans.className} text-zinc-300 capitalize`}
          >
            Case: {caseData?.case_info.case_type}{" "}
                                ...
                                <React.Fragment key={comment.comment}>
                                  {comment.commentType === "system" ? (
                                    <>
                                      <div
                                        key={comment.comment}
                                        className="flex flex-col items-start justify-start gap-2 border-b-1 border-zinc-800 w-full p-2"
                                      >
