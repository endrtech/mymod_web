        ...
        <div>
            <div className="flex items-center justify-between gap-2 py-4">
                <div className="flex items-center py-4">
                    <Input
                        ...
                        value={(table.getColumn("caseReason")?.getFilterValue() as string) ?? ""}
                        onChange={(event) =>
                            table.getColumn("caseReason")?.setFilterValue(event.target.value)
                        }
                        className="max-w-lg text-white bg-zinc-900 border-zinc-700 placeholder:text-zinc-500 focus-visible:ring-0 focus-visible:border-zinc-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900"
                        type="text"
                    />
                </div>
            ...
            <div className="rounded-md">
                <Table className="dark">
                    <TableHeader className="dark bg-black/90">
