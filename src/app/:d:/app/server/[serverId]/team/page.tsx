                ...
                <div className="flex flex-col items-left mt-[15px] w-full p-6">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbLink href={`/:d:/app/server/${currentServerData?.data.dsData.id}/team`} className="hover:text-white">Team</BreadcrumbLink>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                    <div className="flex flex-row items-center justify-between w-full z-[99]">
                        ...
                        <Dialog>
                            ...
                            <DialogContent className="dark text-white">
                                <DialogTitle className="text-white">What does each role do?</DialogTitle>
                                <p className="text-zinc-400">
                                    ...
                                    every aspect of the instance the same way a server owner
                                    can, but they <b>cannot delete the instance.</b>
                                    <br />
                                    The <b>Moderator</b> role allows a MYMOD user to manage
                                    Cases, members, modules and the Audit Log for the instance.
                                    <br />
