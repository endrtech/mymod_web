        ...
        <CardContent className="p-2 overflow-y-auto h-[100%]">
          <div className="flex flex-col gap-2 items-start w-full">
            ...
            <Label
              ...
              className="text-zinc-500 text-sm w-full"
            >
            ...
            <h4 className="text-sm uppercase text-left w-full font-bold text-zinc-500">
              Safety Setup
            </h4>
            <div className="flex flex-col md:flex-row gap-1 items-center justify-between w-full">
              <div className="flex flex-col gap-1 items-start">
                <Label htmlFor="mymodLogChannel" className="text-white">
                  Verification level
                </Label>
                <Label
                  htmlFor="mymodLogChannel"
                  className="text-zinc-500 text-sm w-[80%]"
                >
              ...
              >
                ...
                <SelectContent side="bottom" className="dark w-[70%] md:w-full">
                  <SelectItem
                    value="0"
                  ...
                  <SelectItem
                    value="1"
                    className="border-l-2 rounded-none rounded-r-sm border-green-500 text-wra"
                  >
                    Low - Must have a verified email on their account
                  </SelectItem>
                  <SelectItem
                    value="2"
                    className="border-l-2 rounded-none rounded-r-sm border-yellow-500 text-wra"
                  >
                  ...
                  <SelectItem
                    value="3"
                    className="border-l-2 rounded-none rounded-r-sm border-orange-500 text-wra"
                  >
            ...
            <div className="flex flex-col md:flex-row gap-1 items-start md:items-center justify-between w-full">
              <div className="flex flex-col gap-1 items-start">
                ...
                <Label
                  htmlFor="mymodLogChannel"
                  className="text-zinc-500 text-sm max-w-[80%]"
                >
              ...
              >
                ...
                <SelectContent className="dark w-[70%] md:w-full">
