        ...
        <Card className="w-full h-[100%] overflow-y-auto bg-black border-zinc-700 p-4">
            <div className="flex flex-col gap-2 items-start w-full text-white">
                ...
                <div className="flex flex-row gap-1 items-center justify-between w-full">
                    <Label htmlFor="mymodLogChannel" className="text-white w-[40%]">Administrators can access Overview</Label>
                    <div className="flex flex-row gap-1 items-center">
                        <Switch name="mymodLogChannel" onCheckedChange={(e) => setRoleAccessAdmin(e)} checked={roleAccessAdmin} className="dark" />
                        <Button variant="outline" size="icon" className="dark text-white" onClick={() => updateSetting("overview_role_access_administrator", roleAccessAdmin)}>
                            <Save />
                        </Button>
                    </div>
                </div>
                <div className="flex flex-row gap-1 items-center justify-between w-full">
                    <Label htmlFor="mymodLogChannel" className="text-white w-[40%]">Moderators can access Overview</Label>
                    <div className="flex flex-row gap-1 items-center">
                        <Switch name="mymodLogChannel" onCheckedChange={(e) => setRoleAccessMod(e)} checked={roleAccessMod} className="dark" />
                        <Button variant="outline" size="icon" className="dark text-white" onClick={() => updateSetting("overview_role_access_moderator", roleAccessMod)}>
                            <Save />
                        </Button>
                    </div>
                </div>
                <div className="flex flex-row gap-1 items-center justify-between w-full">
                    <Label htmlFor="mymodLogChannel" className="text-white w-[40%]">Helpers can access Overview</Label>
                    <div className="flex flex-row gap-1 items-center">
                        <Switch name="mymodLogChannel" onCheckedChange={(e) => setRoleAccessHelper(e)} checked={roleAccessHelper} className="dark" />
                        <Button variant="outline" size="icon" className="dark text-white" onClick={() => updateSetting("overview_role_access_helper", roleAccessHelper)}>
                            <Save />
                        </Button>
                    </div>
                </div>
