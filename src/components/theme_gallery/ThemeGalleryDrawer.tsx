...
import { ThemeGallery_ThemeCreatorDrawer } from "./ThemeGallery_ThemeCreatorDrawer";
...
export const ThemeGalleryDrawer = ({ currentServerData }: any) => {
  ...
  return (
    <Drawer>
      ...
      <DrawerContent className="h-[100%] w-full bg-black border-zinc-800 dark text-white">
        <DrawerTitle className="flex w-full flex-row items-center justify-between h-fit gap-2 py-6 px-2 md:p-0">
          ...
          <Drawer>
            <DrawerTrigger className="justify-self-end" asChild>
            ...
            <DrawerContent className="dark text-white">
              <div className="mt-4 p-2">
                ...
                <div className="flex flex-col w-full gap-2">
                  <ThemeGallery_ThemeCreatorDrawer user={userData?.id} />
                  <Drawer>
                    <DrawerTrigger asChild>
                      <div className="dark hover:bg-zinc-800 p-2 rounded-lg transition-all duration-200 h-auto text-white text-left">
                        <div className="flex flex-col gap-2 items-start text-left">
                          <Paintbrush className="text-purple-500" size={30} />
                          <div className="flex flex-col gap-1 items-start">
                            <span className="text-md font-bold">My Themes</span>
                    ...
                    <DrawerContent className="h-[70%] dark text-white">
                      <DrawerTitle className="mt-2 px-2">
                        Your Themes
                      </DrawerTitle>
                      <DrawerDescription className="px-2">
                        To modify a theme, head to Theme Creator.
                      </DrawerDescription>
                      <div className="mt-2 h-[80%] p-2 overflow-y-auto">
        ...
        >
          <div className="flex flex-row w-full items-center justify-between px-2">
            <TabsList className="dark text-white flex flex-row items-center gap-2">
              ...
              <TabsTrigger value="favourites" disabled>
                Favourites
              </TabsTrigger>
            </TabsList>
          ...
          <TabsContent
            value="featured"
            className="w-full h-[90vh] overflow-y-auto whitespace-nowrap p-2 scrollbar-thin scrollbar-thumb-zinc-700"
          >
            <div className="flex flex-col items-start gap-4 w-full">
              {themes?.data?.map((theme: any) => (
                <Dialog key={theme.id}>
                          ...
                          <Badge className="mt-1 dark bg-zinc-900 text-white flex flex-row items-center gap-2">
                            {theme.system_theme === true ? (
                              ...
                              <div className="flex flex-row items-center gap-2">
                                ...
                                <span>
                                  {"Made by " + theme.creator_info.globalName ||
                  ...
                  <DialogContent className="dark h-[80vh] flex flex-col text-white overflow-y-auto">
